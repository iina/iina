...
- **[Keystone](https://github.com/lenadweb/iina-plugin-keystone)** (`lenadweb/iina-plugin-keystone`) - Vertical and horizontal keystone correction for projectors, adjusted live from the sidebar or keyboard.
