...
struct Preference {
  ...
  static let defaultPreference: [Preference.Key: Any] = [
    ...
    .subTextFont: "HelveticaNeue",
    .subTextSize: Float(50),
    ...
    .subBlur: Float(0),
    .subSpacing: Float(0),
    .subBorderSize: Float(2),
    .subBorderColor: NSArchiver.archivedData(withRootObject: NSColor.black),
    .subShadowSize: Float(1.5),
    .subShadowColor: NSArchiver.archivedData(withRootObject: NSColor.black.withAlphaComponent(0.5)),
