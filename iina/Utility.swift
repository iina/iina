...
class Utility {
  ...
  static func quickSavePanel(title: String, types: [String],
    ...
    case .sheet:
      guard let sheetWindow = sheetWindow else {
        Logger.general.fatal("No sheet window")
      }
  ...
  static func createDirIfNotExist(url: URL) {
    ...
    if !FileManager.default.fileExists(atPath: path) {
      ...
      try FileManager.default.createDirectory(at: url, withIntermediateDirectories: true, attributes: nil)
        ...
        Logger.general.fatal("Cannot create directory: \(url)")
      }
    }
  }
  ...
  static let appSupportDirUrl: URL = {
    ...
    Logger.general.assert(asPath.count >= 1, "Cannot get path to Application Support directory")
  ...
  static let logDirURL: URL = {
    ...
    Logger.general.assert(libraryPath.count >= 1, "Cannot get path to Logs directory")
  ...
  static let thumbnailCacheURL: URL = {
    ...
    Logger.general.assert(cachesPath.count >= 1, "Cannot get path to Caches directory")
    let bundleID = Bundle.main.bundleIdentifier!
