...
extension VideoTime: Comparable {
  static func <(lhs: VideoTime, rhs: VideoTime) -> Bool {
  ...
  static func *(lhs: VideoTime, rhs: Double) -> VideoTime {
    return VideoTime(lhs.second * rhs)
  }

  static func /(lhs: VideoTime?, rhs: VideoTime?) -> Double? {
  ...
  static func -(lhs: VideoTime, rhs: VideoTime) -> VideoTime {
